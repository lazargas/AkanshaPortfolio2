...
const TextAbout = () => {
  ...
  return (
    <div className="" >
      <div className="pl-8 pt-5 pb-5 ">
        <div className="w-[345px] not-italic font-semibold text-[22px] leading-7 text-white font-sora text-left  ">
          WHY ME ?
        </div>
        <div className="w-[345px] not-italic font-semibold text-[35px] leading-7 text-white text-left font-sora ">
          I am 
        </div>
        <div className="font-grand tracking-[5px] not-italic font-semibold text-[58px] text-[#CC66F0] text-left">
        ...
        <div className="w-[350px]  not-italic font-sora text-base leading-5 text-white z-[3] text-left  ">
