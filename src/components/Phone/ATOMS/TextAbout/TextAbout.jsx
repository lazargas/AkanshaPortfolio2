  ...
  return (
    <div className="w-full" >
      <div className="py-5 px-3">
        <div className="not-italic font-semibold text-[22px] leading-7 text-white font-sora text-left  ">
          WHY ME ?
        </div>
        <div className="not-italic font-semibold text-[35px] leading-7 text-white text-left font-sora ">
          I am
        </div>
        <div className="font-grand tracking-[5px] not-italic font-semibold text-[40px] text-[#CC66F0] text-left">
        ...
        <div className="not-italic font-sora text-base leading-5 text-white z-[3] text-left  ">
